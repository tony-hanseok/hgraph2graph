...
from generation.poly_hgraph.rnn import GRU, LSTM
...
class HierMPNEncoder(nn.Module):
    ...
    def __init__(self, vocab, atom_vocab, rnn_type, embed_size, hidden_size, depthT, depthG, dropout):
        super(HierMPNEncoder, self).__init__()
        self.vocab = vocab
        self.hidden_size = hidden_size
        self.dropout = dropout
        self.atom_size = atom_size = atom_vocab.size()
...
class IncHierMPNEncoder(HierMPNEncoder):
    ...
    def __init__(self, vocab, atom_vocab, rnn_type, embed_size, hidden_size, depthT, depthG, dropout):
        super(IncHierMPNEncoder, self).__init__(vocab, atom_vocab, rnn_type, embed_size, hidden_size, depthT, depthG,
                                                dropout)
